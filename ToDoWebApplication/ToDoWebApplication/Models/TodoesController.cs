...
namespace ToDoWebApplication.Models
{
    ...
    {
        private readonly ToDoWebApplicationContext _context;

        public TodoesController(ToDoWebApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Todo != null ? 
                          ...
                          Problem("Entity set 'ToDoWebApplicationContext.Todo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ToDoWebApplicationContext.Todo'  is null.");
            }
            var todo = await _context.Todo.FindAsync(id);
            if (todo != null)
            {
